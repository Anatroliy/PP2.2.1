...
//        Car car1 = new Car("Golf",3).setUser(user1).getCars();
        Car car1 = new Car("Golf",3);
        Car car2 = new Car("Passat",3);
        Car car3 = new Car("Scirocco",2);
        ...
        System.out.println(userService.getUser("Golf",3));
